...
public class FastDFSUtils {
	...
	public static String savePic(byte[] file_buff, String file_ext_name, MultipartFile pic) throws IOException, MyException
			{
	...
	public static String savePic(byte[] file_buff, String file_ext_name) throws IOException, MyException {
		return savePic(file_buff, file_ext_name, null);
	}
	
	public static String savePic(byte[] file_buff, MultipartFile pic) throws IOException, MyException {
